  ...
  <div class="row">
        <div class="col-lg-12">
            ...
            {!! Form::open(['route' => 'reportes.repAdmin','method' => 'GET'])!!}
                ...
                <div class="col-lg-10">
                {!! Form::select('id_ubicacion',$ubica,$request->id_ubicacion,['class'=>'form-control','placeholder'=>' TODAS LAS SUCURSALES'])!!}
                 </div> 
                <div class="col-lg-2">
                ...
                <div class="panel-body">
                    <div class="list-group">
                        @foreach($emp_rank as $emp)
                            <a href="{{ route('visitas.AdminTopEmpleados',['id'=>$request -> id_ubicacion,'id2'=>$emp -> ci_empleado])}}" class="list-group-item">
                ...
                <div class="panel-body">
                    <div class="list-group">
                        @foreach($mot_rank as $mot)
                            <a href="{{ route('visitas.AdminTopMotivos',['id'=>$request -> id_ubicacion,'id2'=>$mot -> id_motivo])}}" class="list-group-item">
                ...
                <div class="panel-body">
                    <div class="list-group">
                        @foreach($vis_rank as $vis)
                            <a href="{{ route('visitas.AdminTopVisitantes',['id'=>$request -> id_ubicacion,'id2'=>$vis -> ci_visitante])}}" class="list-group-item">
